  ...
  return (
    <div className="pt-[11px] mb-12 bg-off-white lg:h-screen">
      ...
      <div className="container mx-auto">
        ...
        <div className="bg-custom-black rounded-[22px] flex pl-12 pr-[43px] justify-between pt-[38px] max-sm:mt-6 sm:mt-7 lg:mt-[35px] relative pb-[43px] max-sm:flex-wrap max-sm:pt-4 max-sm:px-5 max-sm:pb-20">
